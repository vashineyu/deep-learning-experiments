...
_C.SOURCE.TARGET_FILES = [
    "/mnt/nas/testcase_data/natural_image_01.jpg",
    "/mnt/nas/testcase_data/natural_image_02.jpg",
    "/mnt/nas/testcase_data/natural_image_03.jpg"
]
...
_C.LOADER = CN()
# loader workers
_C.LOADER.NUM_WORKERS = 4  # per gpu
# batch size for model when inferencing
_C.LOADER.BATCH_SIZE = 512  # per gpu
